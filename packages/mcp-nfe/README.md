...
**MCP Server para NFe API** — Conecte qualquer AI Agent ao NFe via Model Context Protocol.
...
```bash
git clone https://github.com/EvandroSchechtel/mcp-nfe.git
cd mcp-nfe
npm install
npm run build
npm run inspect
