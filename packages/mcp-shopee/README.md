...
**MCP Server para Shopee API** — Conecte qualquer AI Agent ao Shopee via Model Context Protocol.
...
|----------|-----|
| Itens | `shopee://items` |
| Pedidos | `shopee://orders` |
| Perfil | `shopee://profile` |
...
```bash
npm install @bridgeapi/mcp-shopee
```
...
```bash
git clone https://github.com/EvandroSchechtel/mcp-shopee.git
cd mcp-shopee
npm install
npm run build
npm run inspect
