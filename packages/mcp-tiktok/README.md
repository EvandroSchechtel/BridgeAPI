...
**MCP Server para TikTok API** — Conecte qualquer AI Agent ao TikTok via Model Context Protocol.
...
|----------|-----|
| Itens | `tiktok://items` |
| Pedidos | `tiktok://orders` |
| Perfil | `tiktok://profile` |
...
```bash
npm install @bridgeapi/mcp-tiktok
```
...
```bash
git clone https://github.com/EvandroSchechtel/mcp-tiktok.git
cd mcp-tiktok
npm install
npm run build
npm run inspect
